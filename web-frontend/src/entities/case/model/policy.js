...
export function getCaseStageBadgeClass(stageOrCase, options) {
  const stage = stageOrCase?.id ? stageOrCase : resolveCaseStage(stageOrCase, options)
...
export function getCaseStageReminderLevel(stageOrCase, options) {
  const stage = stageOrCase?.id ? stageOrCase : resolveCaseStage(stageOrCase, options)
