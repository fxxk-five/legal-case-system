    ...
    <el-dialog v-model="createDialogVisible" width="720px" title="新建租户">
      <div class="space-y-5">
        <div class="rounded-2xl border border-slate-200 bg-slate-50/70 p-4">
          ...
          <div class="mt-4 inline-flex rounded-xl border border-slate-200 bg-white p-1">
            <button
              type="button"
              class="rounded-lg px-4 py-2 text-sm transition-colors"
              :class="createDialogMode === 'organization' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-100'"
              @click="createDialogMode = 'organization'"
            >
              机构空间
            </button>
            <button
              type="button"
              class="rounded-lg px-4 py-2 text-sm transition-colors"
              :class="createDialogMode === 'personal' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-100'"
              @click="createDialogMode = 'personal'"
            >
              个人空间
            </button>
          </div>
...
import { formatTenantStatus, formatTenantType } from '../shared/lib/displayText'
import {
