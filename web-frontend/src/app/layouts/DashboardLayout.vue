  ...
  <div class="min-h-screen bg-background flex">
    <aside class="hidden lg:flex w-64 border-r border-border bg-card/50 backdrop-blur-xl flex-col sticky top-0 h-screen transition-all duration-300">
      <div class="p-6 flex items-center gap-3">
        ...
        <div>
          <h2 class="font-semibold text-foreground tracking-tight">律证案件系统</h2>
          <p class="text-xs text-muted-foreground">Web 工作台</p>
        </div>
      </div>
        ...
        <aside class="absolute inset-y-0 left-0 w-64 bg-card border-r border-border shadow-2xl flex flex-col">
          <div class="p-6 flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <span class="font-semibold">律证案件系统</span>
            </div>
...
import { getVisibleNavItems } from '../../features/auth/lib/accessControl'
import { useAuthStore } from '../../features/auth/model/store'
import { useNotificationStore } from '../../features/notifications/model/store'
import { formatRole } from '../../shared/lib/displayText'
